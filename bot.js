...
exports.start = function(SETUP) {
  ...
  const UpdateEmbed = function() {
    ...
    .setAuthor("Euphrosyne Status", "https://cdn.discordapp.com/attachments/909740408932814912/911480018465619968/MLB_4.png")
    .setColor(0x2894C2)
    .setFooter(TICK_N % 2 === 0 ? '⚪ ListaBlanca' : '⚫ ListaBlanca')
    .setTimestamp(new Date())
    .addField('\n\u200b\nBat ang pogi ni marcus?','Even the scientists cant explain how hot marcus is. He is different of all amongs people.\n\u200b\n',false)
    if (STATUS !== undefined)
    {
  ...
  bot.on('ready',() => {
    ...
    bot.user.setActivity('ListaBlanca',{'url':'https://www.youtube.com/channel/UCkqMw81s2aw7bYO-U2YhD7w?view_as=subscriber','type':'STREAMING'});
